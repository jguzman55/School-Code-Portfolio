...
to setup
  ...
  create-turtles 2 [
     set friendship random-float 5.0
    set color red
    fd 5
  ]
...
to go
  ...
  ifelse use-friendship [
    let partners [ both-ends ] of one-of links
    let partner max-one-of partners [ friendship]
    create-turtles 1 [
      set color red
      set friendship random-float 5.0
      move-to partner
