...
to setup
  ...
  create-sheep number-of-sheep [
    ...
    set shape "sheep"
    set energy 100
    set my-energy-gain (random-float 10.0)
  ]
  reset-ticks
end
...
to reproduce
  ...
  if energy > 200 [
    ...
    hatch 1 [set my-energy-gain my-energy-gain + (-10 + random-float 20) ;make negative

   setxy parent-xcor parent-ycor
    ]

    ;[ set energy 100 ] ;; to the new agent
;  let parent-xcor xcor
;  let parent-ycor ycor
...
to eat
  ...
  ;set energy-gain-from-grass my-energy-gain ; set it to this since it was already done but now the slider doesnt work because it updates it to the number or my-energy-gain
...
to eat2
  if ( grass-amount >= my-energy-gain ) [
    ;; increment the sheep's energy
    set energy energy + my-energy-gain
    ;; decrement the grass
    set grass-amount grass-amount - my-energy-gain
    recolor-grass
  ]
end
...
;  ;plot count sheep
;;  ask patches [
;   ;plot mean [grass-amount] of patches ;part b
;;  ]
;end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [grass-amount] of patches"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [my-energy-gain] of sheep"
