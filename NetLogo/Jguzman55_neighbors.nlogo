...
to go
  ...
  ;below maybe this goes somewhere after everyone is happy?
  ;maybe an if statement so it shows up when all the patches are the same color?
 ; if (turtles in-radius 1 with color  [
...
to update-globals
  ...
  ;let neighborhood-size (2 (neighborhood-size) + 1)
