...
to go
  ...
  ask fire-patches [ ;; ask the burning trees


;    ask neighbors in-radius 8 with [pcolor = green] [ ;; ask their non-burning neighbor trees
;      set pcolor red ;; to catch on fire
;    ]
;

    ifelse neighbor-spread?
    [ ask neighbors4 with [pcolor = green]
      [set pcolor red] ]

   [ ask neighbors in-radius 8 with [pcolor = green]
      [set pcolor red] ]
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count fire-patches"
